...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Austin Nason"
    user-mail-address "austin.nason@schrodinger.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/nason/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/nason/bin" "/profile/bin" "/Users/nason/.npm-packages/bin" "/Users/nason/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
